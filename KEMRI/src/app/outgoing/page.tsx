...
import { Search, Filter, Download, Eye, Clock, CheckCircle, XCircle, ChevronLeft, ChevronRight, Send } from 'lucide-react';
...
const documents: Document[] = [
  {
    ...
    recipient: 'National Health Institute',
    sentDate: '2024-03-25',
    priority: 'High',
    status: 'Pending',
    category: 'Research',
    fileUrl: '/sample-proposal.pdf', // In a real app, this would be a URL to the actual file
  },
  {
    id: 'OUT-002',
  ...
  },
  {
    ...
    recipient: 'Medical Supplies Ltd',
    sentDate: '2024-03-23',
    priority: 'Low',
    status: 'Draft',
    category: 'Operations',
  ...
  ...Array.from({ length: 7 }, (_, i) => ({
    id: `OUT-00${i + 4}`,
    title: `Outgoing Document ${i + 4}`,
    recipient: 'Various Recipients',
    sentDate: '2024-03-22',
    priority: ['High', 'Medium', 'Low'][Math.floor(Math.random() * 3)],
    status: ['Pending', 'Sent', 'Draft'][Math.floor(Math.random() * 3)],
    category: ['Research', 'Reports', 'Operations'][Math.floor(Math.random() * 3)],
  })),
];
...
export default function OutgoingPage() {
  ...
  const handleSendDocument = (documentId: string) => {
    // In a real app, this would trigger the document sending process
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-800">Outgoing Documents</h1>
        <motion.button
              ...
              <tbody className="divide-y divide-gray-200">
                {paginatedDocuments.map((doc) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500">{doc.recipient}</td>
                    <td className="px-6 py-4 text-sm text-gray-500">{doc.sentDate}</td>
                    <td className="px-6 py-4">
